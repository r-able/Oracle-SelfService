...
#   */5 * * * * /etc/ansible/JIRA_REF_cron_wrapper.sh >> /tmp/cron.REF.log 2>&1
...
PLAYBOOK="JIRA_REF_oracle_schema_refresh.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/jira_ref"                    # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/jira_ref.pid"
