...
#   */5 * * * * /etc/ansible/JIRA_CAU_cron_wrapper.sh >> /tmp/cron.log 2>&1
...
PLAYBOOK="JIRA_CAU_create_user.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/jira_cau"                    # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/jira_cau.pid"
