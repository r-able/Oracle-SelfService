#!/usr/bin/env bash
# UPG_snow_cron_wrapper.sh
# Released under the MIT license. Copyright (c) 2026, Vlad von Grigorian <
#
# Cron-safe wrapper for the UPG playbook (SNOW_UPG_oracle_upgrade.yml).
# ServiceNow-driven Oracle 21c to 26ai upgrade.
#
...
#
# This is the ServiceNow counterpart of UPG_jira_cron_wrapper.sh. It is
...
#   */5 * * * * /etc/ansible/UPG_snow_cron_wrapper.sh >> /tmp/cron.UPG.snow.log 2>&1
...
PLAYBOOK="SNOW_UPG_oracle_upgrade.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/snow_upg"                  # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/snow_upg.pid"
...
log "========================================================"
log "ServiceNow UPG wrapper started (PID $$)"
