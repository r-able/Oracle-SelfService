...
#   */5 * * * * /etc/ansible/JIRA_PAT_cron_wrapper.sh >> /tmp/cron.PAT.log 2>&1
...
PLAYBOOK="JIRA_PAT_oracle_patch.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/jira_pat"                    # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/jira_pat.pid"
