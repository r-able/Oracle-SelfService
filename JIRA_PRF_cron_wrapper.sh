...
# JIRA_PRF_cron_wrapper.sh
#
# Cron-safe wrapper for the PRF playbook (JIRA_PRF_performance_analysis.yml).
#
...
#   */5 * * * * /etc/ansible/JIRA_PRF_cron_wrapper.sh >> /tmp/cron.PRF.log 2>&1
...
PLAYBOOK="JIRA_PRF_performance_analysis.yml"
