#!/usr/bin/env bash
# PAT_snow_cron_wrapper.sh
# Released under the MIT license. Copyright (c) 2026, Vlad von Grigorian <
#
# Cron-safe wrapper for the PAT playbook (SNOW_PAT_oracle_patch.yml).
# ServiceNow-driven Oracle patching.
#
...
#
# This is the ServiceNow counterpart of PAT_jira_cron_wrapper.sh. It is
...
#   */5 * * * * /etc/ansible/PAT_snow_cron_wrapper.sh >> /tmp/cron.PAT.snow.log 2>&1
...
PLAYBOOK="SNOW_PAT_oracle_patch.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/snow_pat"                  # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/snow_pat.pid"
...
log "========================================================"
log "ServiceNow PAT wrapper started (PID $$)"
