...
#   */5 * * * * /etc/ansible/JIRA_DCR_cron_wrapper.sh >> /tmp/cron.log 2>&1
...
PLAYBOOK="JIRA_DCR_data_change.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/jira_dcr"                    # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/jira_dcr.pid"
