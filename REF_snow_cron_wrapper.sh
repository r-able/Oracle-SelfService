#!/usr/bin/env bash
# REF_snow_cron_wrapper.sh
# Released under the MIT license. Copyright (c) 2026, Vlad von Grigorian <
#
# Cron-safe wrapper for the REF playbook (SNOW_REF_oracle_schema_refresh.yml).
# ServiceNow-driven Oracle schema refresh.
#
...
#
# This is the ServiceNow counterpart of REF_jira_cron_wrapper.sh. It is
...
#   */5 * * * * /etc/ansible/REF_snow_cron_wrapper.sh >> /tmp/cron.REF.snow.log 2>&1
...
PLAYBOOK="SNOW_REF_oracle_schema_refresh.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/snow_ref"                  # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/snow_ref.pid"
...
log "========================================================"
log "ServiceNow REF wrapper started (PID $$)"
