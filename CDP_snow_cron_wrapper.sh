#!/usr/bin/env bash
# CDP_snow_cron_wrapper.sh
# Released under the MIT license. Copyright (c) 2026, Vlad von Grigorian <
#
# Cron-safe wrapper for the CDP playbook (SNOW_CDP_reset_own_oracle_password.yml).
# ServiceNow-driven Oracle password reset.
#
...
#
# This is the ServiceNow counterpart of CDP_jira_cron_wrapper.sh. It is
...
#   */5 * * * * /etc/ansible/CDP_snow_cron_wrapper.sh >> /tmp/cron.CDP.snow.log 2>&1
...
LOCK_FILE="${BASE_DIR}/snow_cdp.pid"
...
log "========================================================"
log "ServiceNow CDP wrapper started (PID $$)"
