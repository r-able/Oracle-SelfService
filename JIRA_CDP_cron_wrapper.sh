...
#   */5 * * * * /etc/ansible/JIRA_CDP_cron_wrapper.sh >> /tmp/cron.CDP.log 2>&1
...
PLAYBOOK="JIRA_CDP_reset_own_oracle_password.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/jira_cdp"                    # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/jira_cdp.pid"
