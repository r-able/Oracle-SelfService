#!/usr/bin/env bash
# CAU_snow_cron_wrapper.sh
# Released under the MIT license. Copyright (c) 2026, Vlad von Grigorian <
#
# Cron-safe wrapper for the CAU playbook (SNOW_CAU_create_user.yml).
# ServiceNow-driven Oracle user creation.
#
...
#
# This is the ServiceNow counterpart of CAU_jira_cron_wrapper.sh. It is
...
#   */5 * * * * /etc/ansible/CAU_snow_cron_wrapper.sh >> /tmp/cron.CAU.snow.log 2>&1
...
PLAYBOOK="SNOW_CAU_create_user.yml"
VAULT_PASS_FILE="/etc/ansible/.vault_pass"     # file containing the vault password

BASE_DIR="${HOME}/snow_cau"                  # user-owned; survives reboots
LOCK_FILE="${BASE_DIR}/snow_cau.pid"
...
log "========================================================"
log "ServiceNow CAU wrapper started (PID $$)"
