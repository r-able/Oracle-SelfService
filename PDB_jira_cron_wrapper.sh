...
# PDB_jira_cron_wrapper.sh
#
# Cron-safe wrapper for the PDB playbook (PDB_jira_create_pluggable_database.yml).
#
...
#   */5 * * * * /etc/ansible/PDB_jira_cron_wrapper.sh >> /tmp/cron.PDB.log 2>&1
...
PLAYBOOK="PDB_jira_create_pluggable_database.yml"
